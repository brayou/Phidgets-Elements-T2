...
class SensorChangeEventArgs:
    ...
    """
    def __init__(self, index, value, device):   ## Ruth: added the device arg
        self.index = index
        self.value = value
        self.device = device                    ## Ruth: added the device arg
...
class InputChangeEventArgs:
    ...
    """
    def __init__(self, index, state, device):   ## Ruth: added the device arg
        self.index = index
        self.state = state
        self.device = device                    ## Ruth: added the device arg
